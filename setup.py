...
METADATA = {
    ...
    'author':           '',
    #'author_email':     '',
    'url':              'http://pyweek.org/e/mooncrete',
    'classifiers':      [
...
PACKAGEDATA = {
    ...
    'package_dir': {'mooncrete': 'mooncrete',
                   },
    'packages': ['mooncrete',
                ],
    'scripts': ['scripts/mooncrete'],
}
...
_DATA_DIR = os.path.join('mooncrete', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'mooncrete': data_dirs}
...
src = []
add_files(src,os.walk('mooncrete'))
